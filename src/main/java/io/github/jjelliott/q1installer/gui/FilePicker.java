...
public class FilePicker {
    ...
    private Runnable onPathSelected;
    private boolean selectFolder;

    public FilePicker(String idFrag, String label, String buttonLabel, boolean selectFolder, String defaultValue, Runnable onPathSelected) {
        this.idFrag = idFrag;
        this.label = label;
